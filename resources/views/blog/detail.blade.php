...
<div class="">
    <div class="py-3">
        ...
        <div class="nav d-flex justify-content-between p-3">
            <a href="{{ isset($previousArticl) ? route('detail',$previousArticle->id) : '#' }}" class="btn btn-outline-primary page-mover rounded-circle @empty($previousArticle) disabled @endempty">
            ...
            <a href="{{ isset($nextArticle) ? route('detail',$nextArticle->id) : '#' }}" class="btn btn-outline-primary page-mover rounded-circle @empty($nextArticle) disabled @endempty">
